...
from agentsociety.environment.environment import Environment
...
class FirmPlanBlock(Block):
    ...
    def __init__(self, llm: LLM, environment: Environment, memory: Memory):
        super().__init__("FirmPlanBlock", llm=llm, environment=environment, memory=memory)
